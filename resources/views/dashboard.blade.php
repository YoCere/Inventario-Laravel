    ...
    <div class="py-1 bg-gray-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-100 overflow-hidden text-gray-100 shadow-xl sm:rounded-lg">
                ...
                <p>Quas minima eius eveniet provident ratione. Quia harum ducimus similique omnis eligendi aperiam sunt tempore quam numquam veniam tempora magnam autem, amet officia ut ipsa, sit beatae laboriosam doloribus iure?</p>
                <p>Placeat consequuntur fugit quibusdam! Debitis ea, odit explicabo molestias amet vel velit doloremque quas quisquam sint laudantium reiciendis tempore quos numquam ratione voluptatibus esse quis aliquid, cupiditate facilis quae? Eaque?</p>
            </div>
        </div>
    </div>
</x-app-layout>
